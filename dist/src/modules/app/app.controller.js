...
export async function getAllAppsController(req, res) {
    try {
...
export async function getAppByIdController(req, res) {
    try {
        const result = await getAppById(req.params.id, getAuthUser(req));
        if (!result) {
